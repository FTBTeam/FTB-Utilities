...
public class CmdLoad extends CmdBase
{
	...
	public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException
	{
		...
		{
			Notification.of(FTBUtilitiesNotifications.CHUNK_MODIFIED, TextComponentHelper.createComponentTranslation(player, "ftbutilities.lang.chunks.chunk_loaded")).send(server, player);
