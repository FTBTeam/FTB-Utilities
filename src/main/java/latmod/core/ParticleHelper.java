...
public class ParticleHelper
{
	...
	public static void spawnFallParticles(World w, double x, double y, double z, int c, Block b, int m) // RenderGlobal // 2006
	{
		...
		{
			float f3 = MathHelper.randomFloatClamp(rand, 0.0F, ((float)Math.PI * 2F));
			double d5 = (double)MathHelper.randomFloatClamp(rand, 0.75F, 1.0F);
			...
			w.spawnParticle("blockdust_" + Block.getIdFromBlock(b) + "_" + m, x, y, z, d7, d6, d8);
		}
	}
}