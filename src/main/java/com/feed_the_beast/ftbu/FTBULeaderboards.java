...
public class FTBULeaderboards
{
    ...
    public static void addLeaderboards(IFTBUtilitiesRegistry reg)
    {
        ...
        reg.addLeaderboard(STAT_DEATHS_PER_HOUR, (o1, o2) -> Double.compare(FTBLibStats.getDeathsPerHour(o2.stats()), FTBLibStats.getDeathsPerHour(o1.stats())), player -> MathHelperLM.toSmallDouble(FTBLibStats.getDeathsPerHour(player.stats())));
        reg.addLeaderboard(StatList.PLAY_ONE_MINUTE, (o1, o2) -> Integer.compare(o2.stats().readStat(StatList.PLAY_ONE_MINUTE), o1.stats().readStat(StatList.PLAY_ONE_MINUTE)), player -> MathHelperLM.toSmallDouble(player.stats().readStat(StatList.PLAY_ONE_MINUTE) / 72000D) + "h", FTBLibStats.TIME_PLAYED_LANG.textComponent());
        reg.addLeaderboard(FTBLibStats.LAST_SEEN, (o1, o2) -> Long.compare(FTBLibStats.getLastSeen(o2.stats(), o2.isOnline()), FTBLibStats.getLastSeen(o1.stats(), o1.isOnline())), player ->
        {
            if(player.isOnline())
            {
