...
public class FTBUConfigLogin
{
	...
	public static final ConfigEntryStringArray motd = new ConfigEntryStringArray("motd", new FastList<String>("Welcome to the server!")).setInfo("Message of the day. This will be displayed when player joins the server");
	...
	public static final ConfigEntryStringArray startingItems = new ConfigEntryStringArray("startingItems", new FastList<String>("minecraft:apple 16 0")).setInfo("Items to give player when it first joins the server.\nFormat: StringID Size Metadata\nDoes not support NBT yet");
