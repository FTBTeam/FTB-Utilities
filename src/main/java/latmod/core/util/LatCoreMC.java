...
public class LatCoreMC
{
	...
	public static final boolean isDevEnv = LatCore.VERSION.equals("@VERSION@");
	...
	public static void openGui(EntityPlayer ep, IGuiTile i, int ID)
	{
		...
		ep.openGui(LatCore.inst, ID, te.getWorldObj(), te.xCoord, te.yCoord, te.zCoord);
	}
	
	public static void openClientGui(EntityPlayer ep, IGuiTile i, int ID)
	{ LatCore.proxy.openClientGui(ep, i, ID); }
