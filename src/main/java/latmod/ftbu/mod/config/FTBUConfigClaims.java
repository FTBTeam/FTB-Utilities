...
public class FTBUConfigClaims
{
	...
	public static final ConfigEntryEnum<LMSecurityLevel> forcedChunkSecurity = new ConfigEntryEnum<LMSecurityLevel>("forcedChunkSecurity", LMSecurityLevel.class, LMSecurityLevel.VALUES_3, null, true).sync().setInfo("-1 - Player setting\n0 - Public\n1 - Private\n2 - Friends.");
