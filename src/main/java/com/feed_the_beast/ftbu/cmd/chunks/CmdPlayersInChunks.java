...
public class CmdPlayersInChunks extends CmdBase
{
	
    public CmdPlayersInChunks()
    {
        super("Players_in_chunks", Level.OP);
    }
    ...
    public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException
    {
        ...
        if (ClaimedChunkStorage.INSTANCE.getChunk(pos) != null) {
        	...
        	sender.sendMessage(new TextComponentString(String.format("no one has claimed the chunk at x:%d, z:%d", chunkXPos, chunkZPos)));
        }
    }
}
